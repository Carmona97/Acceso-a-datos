...
public class DepartamentosEntidad {
    ...
    private Collection<EmpleadosEntidad> empleadosByDepno;
    ...
    public Collection<EmpleadosEntidad> getEmpleadosByDepno() {
        return empleadosByDepno;
    }

    public void setEmpleadosByDepno(Collection<EmpleadosEntidad> empleadosByDepno) {
