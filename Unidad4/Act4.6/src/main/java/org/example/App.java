...
import entidades.CuentaCredito;
import entidades.CuentaDebito;
...
public class App
{
    ...
    {
        EntityManagerFactory entityManagerFactory = Persistence.createEntityManagerFactory("SingleTable");
