...
public class EntidadDestinos {
    ...
    private Collection<EntidadClientesDestinos> clientesDestinosByDestinoId;
    ...
    public Collection<EntidadClientesDestinos> getClientesDestinosByDestinoId() {
        return clientesDestinosByDestinoId;
    }

    public void setClientesDestinosByDestinoId(Collection<EntidadClientesDestinos> clientesDestinosByDestinoId) {
