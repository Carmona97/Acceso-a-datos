...
import org.example.Entidades.DestinoEntidad;
...
public class Destino {
    ...
    public boolean existeDestino() throws SQLException {
        ...
        DestinoEntidad destinoJPAEntity = new DestinoEntidad();
        respuesta = destinoJPAEntity.existeDestino();

        return respuesta;
    }

    public String mostrarDestinosLogica() throws Exception {
        String respuesta = "";
        DestinoEntidad destinoPersistencia = new DestinoEntidad();
        ArrayList<Destino> destinoLogica = destinoPersistencia.mostrarDestinosPersistencia();

        for (Destino destino : destinoLogica) {
            respuesta = respuesta + "\n" + destino.toString();
        }
    ...
    public boolean agregarDestino() throws SQLException {
        ...
        DestinoEntidad destinoNuevo = new DestinoEntidad();
        respuesta = destinoNuevo.agregarDestino(this);
    ...
    public boolean actualizarDestino() throws SQLException {
        ...
        DestinoEntidad destinoJPAEntity = new DestinoEntidad();
        respuesta = destinoJPAEntity.actualizarDestino(this);
    ...
    public boolean eliminarDestino() throws SQLException {
        ...
        DestinoEntidad destinoJPAEntity = new DestinoEntidad();
        respuesta = destinoJPAEntity.eliminarDestino(this);
    ...
    public boolean cargarDestino() throws SQLException {
        ...
        DestinoEntidad destinoJPAEntity = new DestinoEntidad();
        Destino destino = destinoJPAEntity.cargarDestino(this.id);
        if (destino != null) {
            this.id = destino.id;
